...
public class map extends AppCompatActivity implements OnMapReadyCallback, ActivityCompat.OnRequestPermissionsResultCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        t.setText("의림지 산책로\n" + "소요시간 : 약 분 \n 총 거리 : km \n 산출기준 시속 km/h\n" +
                "이 의림지는 제천을 대표하는 10여 곳의 관광지를 소개하는 제천 10경중 제 1경으로 사랑받고 있는 장소이다.\n" +
                "저수지의 무지개 다리를 지나면서 인공폭포를 볼수 있는데 여름에는 시원함을 맛 볼수 있고, 겨울에는 인공폭포가 얼어서 더 멋진 퐁경을 볼수 있는 연인이랑 가면 더 좋은 산책로이다.");
        ...
        b1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                mGoogleMap.clear();
                t.setText("솔밭공원 산책로\n" + "소요시간 : 약 분 \n 총 거리 : km \n 산출기준 시속 km/h\n" +
                        "커다란 소나무 그늘과 잔디밭으로 신선하고 평화로운 분위기로 느긋하게 산책하며 솔향을 즐기시고 싶은 분들이 가족과함께 많이 오는 산책로이다. \n " + "또 위에 의림지와 굉장히 가까워 의림지를 구경후 솔밭공원으로 오는 경우도 많다.");
                drawPath(arr);
            }
        });
        ...
        b2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                arr=db.getLatLng(2);
                mGoogleMap.clear();
                t.setText("세명대 하늘공원 산책로\n" + "소요시간 : 약 분 \n 총 거리 : km \n 산출기준 시속 km/h\n" +
                        "넓은 잔디밭과 큰 가로수가 있는 하늘공원 산책로는 세명대 학생들, 인근 주민들에게 좋은 쉼터이다. \n " + "또 꽃과 나무가 어우러져 있는 연못이 있고, 또 저녁이 되면 바닥등이 분위기를 높여주어서 연인끼리 좋은 산책로이다.");
                drawPath(arr);
            }
        });
    ...
    public boolean insert_db(mapDB db, double arr[][]){
        if(arr[0][0]==0){
            db.insert(0,37.172280,128.194408);
            db.insert(0,37.172938,128.194429);
            db.insert(0,37.173169,128.194580);
            db.insert(0,37.173306,128.195524);
            db.insert(0,37.174785,128.195363);
            db.insert(0,37.177996,128.194867);
            db.insert(0,37.180787,128.194554);
            db.insert(0,37.180743,128.195771);
            db.insert(0,37.179186,128.196656);
            db.insert(0,37.175308,128.197718);
            db.insert(0,37.175300,128.197053);
            db.insert(0,37.173410,128.196666);
            db.insert(0,37.173299,128.195529);
...
//            db.insert(0,37.174291,128.208636);
//            db.insert(0,37.175186,128.211305);
//            db.insert(0,37.174400,128.212356);
//            db.insert(0,37.173195,128.212699);
//            db.insert(0,37.171545,128.211927);
//            db.insert(0,37.171066,128.209846);
//            db.insert(0,37.172169,128.208837);
//            db.insert(0,37.174238,128.208590);
//            db.insert(1,37.180765,128.205838);
//            db.insert(1,37.180808,128.205247);
//            db.insert(1,37.182637,128.205215);
//            db.insert(1,37.184064,128.204797);
//            db.insert(2,37.176495,128.195002);
//            db.insert(2,37.179760,128.194573);
//            db.insert(2,37.179521,128.193092);
//            db.insert(2,37.178051,128.193425);
//            db.insert(2,37.177162,128.194830);
            return true;
        }
        return false;
    }
